...
namespace QiPOS
{
    public sealed class FrmNewCards : Form
    {
        ...
        /// <summary>
        /// Decided to write my own function on stock id
        /// </summary>
        /// <returns></returns>
        private int GetStockId()
        {
            ...
            string queryStr1 = "SELECT * FROM pos_stock WHERE barcode='" + newBarCode + "'";
            connect.QueryTable(queryStr1);
            DataTable dataTable = connect.aTable;
            if (dataTable.Rows.Count > 0)
            { // you can either get the stock id or not, if not, return 0
                string code = dataTable.Rows[0][0].ToString();
                stockID = Int32.Parse(code);
            }
            return stockID;
        }
        ...
        {
            this.Text = "Editing existing Card";
            this.lblTitle.Text = "Editing existing Card";
            Connect connect = new Connect();
        ...
        private void AddNewInitiate()
        {
            ...
            cbxSupplier.SelectedIndex = this.supplierIndex;
            this.ActiveControl = TxtRRP;
        }
        ...
        private void BtnSave_Click(object sender, EventArgs e)
        {
            ...
            this.supplierIndex = cbxSupplier.SelectedIndex;
        ...
        private void InitializeComponent()
        {
            ...
            this.lblTitle.Text = "Add New Cards";
            // 
            // customButton1
            // 
            ...
            this.Name = "FrmNewCards";
            this.Text = "Add Greeting Cards";
