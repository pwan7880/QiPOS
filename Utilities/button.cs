...
namespace QiPOS
{
    ...
    public class CustomTextbox : TextBox
    {
        ...
        private void DrawText(Graphics g)
        {
            ...
            RectangleF R = (RectangleF)this.DisplayRectangle;
        ...
        protected override void OnPaintBackground(PaintEventArgs pevent)
        {
            ...
            System.Drawing.Drawing2D.GraphicsPath path = RoundRectangle(r, 30, Corners.All);

            System.Drawing.Drawing2D.LinearGradientBrush paintBrush = new System.Drawing.Drawing2D.LinearGradientBrush(r, fillColor, fillColor, System.Drawing.Drawing2D.LinearGradientMode.Vertical);
            ...
            {
                Positions = new float[] { 0, 0.45F, 0.55F, 1 },
                Factors = new float[] { 0, 0.2f, 0.4f, 1 }
            };
            paintBrush.Blend = b;
            ...
            //...and border
            Pen drawingPen = new Pen(this.BackColor);
    ...
    {
        readonly ImageAttributes imgAttribs;
        public CustomButton()
        {
            this.SetStyle(ControlStyles.Selectable | ControlStyles.StandardClick | ControlStyles.ResizeRedraw | ControlStyles.AllPaintingInWmPaint | ControlStyles.DoubleBuffer | ControlStyles.UserPaint | ControlStyles.SupportsTransparentBackColor, true);
...
new float[] {0, 0, 0, 1, 0},new float[] {.90f, .0f, .0f, .0f, 1}
        ...
        readonly ColorMatrix clrMatrix;
        ...
        protected override void OnPaintBackground(PaintEventArgs pevent)
        {
            ...
            Color darkDarkColor = DarkenColor(this.BackColor, 17);
            Color lightColor = LightenColor(this.BackColor, 15);
            //Color lightLightColor = LightenColor(this.BackColor, 45);
        ...
        private void DrawImage(Graphics g)
        {
            ...
            if (this.Enabled)
            {
                if (this.ButtonState == CustomButtonState.Hot)
                {
                    if (BackgroundImage != null)
                    {
                        ...
                        System.Drawing.Drawing2D.GraphicsPath path = RoundRectangle(r, this.CornerRadius, this.RoundCorners);
                        Pen pen = new Pen(Color.White, 4.0f);
                        g.DrawPath(pen, path);
                        pen.Dispose();
                    }
                }
            ...
            else
            {
                if (BackgroundImage != null)
                {
                    ControlPaint.DrawImageDisabled(g, BackgroundImage, pt.X, pt.Y, this.BackColor);
                }
            }
        }
        ...
        #endregion Internal Draw Methods
        ...
        private void OnStateChange(EventArgs _)
        {
    ...
    #endregion Custom TypeEditor for RoundCorners property
}
